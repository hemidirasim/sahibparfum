...
export default function AdminLayout({
  ...
  if (pathname === '/sahib-admin-2024/login') {
    return (
  ...
  const handleLogout = async () => {
    await signOut({ callbackUrl: '/sahib-admin-2024/login' })
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button 
            onClick={() => router.push('/sahib-admin-2024/login')}
  ...
  const navigation = [
    { name: 'Dashboard', href: '/sahib-admin-2024/dashboard', icon: Shield },
    { name: 'İstifadəçilər', href: '/sahib-admin-2024/users', icon: Users },
    { name: 'Sifarişlər', href: '/sahib-admin-2024/orders', icon: ShoppingBag },
    { name: 'Məhsullar', href: '/sahib-admin-2024/products', icon: Package },
    { name: 'Kateqoriyalar', href: '/sahib-admin-2024/categories', icon: BarChart3 },
    { name: 'Markalar', href: '/sahib-admin-2024/brands', icon: Tag },
