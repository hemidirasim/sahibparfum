      ...
      try {
        ...
        if (data.products) {
          ...
          const saleProducts = data.products
            .filter((product: any) => product.salePrice && product.salePrice < product.price)
            .slice(0, 8) // İlk 8 endirimli məhsul
          
          setProducts(saleProducts)
          
          // Check favorite status for all products
          if (session?.user?.id) {
            const productIds = saleProducts.map((p: any) => p.id)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Xüsusi qiymətlərlə parfümləri kəşf edin
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Hal-hazırda endirimli məhsul yoxdur
            </p>
          </div>
        </div>
      </section>
    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          ...
          >
            Bütün Endirimli Məhsulları Gör
          </Link>
        </div>
      </div>
    </section>
