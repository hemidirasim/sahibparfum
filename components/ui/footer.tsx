      ...
      <div className="bg-gray-800 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex flex-wrap items-center justify-center gap-8 py-6 text-base">
            {/* Phone */}
            <a href={`tel:${settings.contactPhone.replace(/\s/g, '')}`} className="flex items-center gap-3 text-white hover:text-pink-300 transition-colors cursor-pointer">
              <Phone className="h-5 w-5 text-pink-500" />
              <span className="font-medium">{settings.contactPhone}</span>
            </a>
            
            {/* WhatsApp */}
            <a href={`https://wa.me/${settings.contactPhone.replace(/\s/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-white hover:text-pink-300 transition-colors cursor-pointer">
            ...
            {/* Email */}
            <a href={`mailto:${settings.contactEmail}`} className="flex items-center gap-3 text-white hover:text-pink-300 transition-colors cursor-pointer">
